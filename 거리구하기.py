...
# 데이터 역할 팀원이 주신 함수get_distance_and_time를 이용해서 각 노드 간 거리를 받아오는 코드를 만들었습니다.
# 제가 이전에 만들었던 다익스트라 코드보다 김현경 팀원이 만든 코드가 더 실용성 있어서 그 코드를 프로그램에 사용하기로 했습니다.
# 서로 맡은 코드를 완성했기 때문에 중간코드 제출 이후에 이 코드들을 합치고 연동시켜보고자 합니다.